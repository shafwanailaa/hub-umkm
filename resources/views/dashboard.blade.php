    ...
    <div class="w-full max-w-md bg-white min-h-screen shadow-2xl relative flex flex-col">
        ...
        <main class="p-6 space-y-6 flex-grow mb-24">
            <div class="bg-gradient-to-br from-[#9333EA] to-[#E879F9] rounded-[32px] p-6 text-white shadow-xl shadow-purple-100">
                ...
                <h3 class="text-4xl font-[900] mb-1 tracking-tight">Rp 95.000</h3>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-white p-5 rounded-[28px] border border-gray-100 shadow-sm flex flex-col items-start">
                    <div class="bg-green-50 p-2.5 rounded-xl mb-3 text-green-500"><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" /></svg></div>
                    <span class="text-[10px] font-black text-gray-400 uppercase tracking-tighter leading-none">Order Hari Ini</span>
                    <span class="text-3xl font-[900] text-green-500 mt-1 leading-none">1</span>
                </div>
                <div class="bg-white p-5 rounded-[28px] border border-gray-100 shadow-sm flex flex-col items-start">
                    <div class="bg-orange-50 p-2.5 rounded-xl mb-3 text-orange-500"><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path d="M4 3a2 2 0 100 4h12a2 2 0 100-4H4z" /><path fill-rule="evenodd" d="M3 8h14v7a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm5 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" clip-rule="evenodd" /></svg></div>
                    <span class="text-[10px] font-black text-gray-400 uppercase tracking-tighter leading-none">Total Produk</span>
                    <span class="text-3xl font-[900] text-orange-500 mt-1 leading-none">3</span>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-[32px] border border-gray-100 shadow-sm">
                ...
                <div class="bg-gray-50/50 rounded-2xl p-4 flex justify-between items-center border border-gray-100">
                    <div>
                        <h5 class="font-bold text-sm text-gray-800">Siska Amalia</h5>
                        <p class="text-[11px] font-black text-[#9333EA]">Rp 50.000</p>
                    </div>
                    <span class="bg-[#F6AD8F] text-white text-[10px] font-black px-4 py-1.5 rounded-full shadow-sm">Pending</span>
                </div>
            </div>
        </main>
